...
const WebSocketMobileHandler = require('./WebSocketMobileHandler');
const debug = require('debug')('JsSIP:WebSocketInterface');
const debugerror = require('debug')('JsSIP:ERROR:WebSocketInterface');

debugerror.log = console.warn.bind(console);

module.exports = class WebSocketInterface extends WebSocketMobileHandler
{
  ...
  _onClose({ wasClean, code, reason })
  {
    ...
    super._onClose({ wasClean, code, reason });
